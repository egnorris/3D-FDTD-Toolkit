...
parser.add_argument('-thickness', nargs='+', required=False, default=[1.5, 12.5])
parser.add_argument('-layer', nargs='+', required=False, default=[150, 157])
parser.add_argument('-stepx', type=float, default=2E-9)
parser.add_argument('-stepy', type=float, default=2E-9)
parser.add_argument('-stepz', type=float, default=2E-9)
